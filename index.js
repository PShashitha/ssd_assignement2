...
app.use(express.static('files/ssd_assignment_2/'));
...
app.get('/index.html',function(req,res){
  res.sendFile( __dirname + "/files/ssd_assignment_2/"+ "index.html" );
});

// app.post('/authAndUpload',function(req, res){
...
function uploadFile(auth,filenamepath, filename) {
  ...
  drive.files.create({
    ...
    if (err) {
      ...
      console.log('File Name: ', file.data.originalFilename);
    }
  });  
